                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-extrabold text-slate-900 tracking-tight">
                            Invoice {order.invoice_no || 'DRAFT'}
                        </h1>
                        <p className="text-slate-400 text-xs font-medium mt-0.5">
                            {order.retailer_name} • {new Date(order.created_at).toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' })}
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                    <button
                        onClick={() => {
                            ...
                            if (navigator.share) {
                                navigator.share({ title: `Invoice ${order.invoice_no || ''}`, url });
                            } else {
