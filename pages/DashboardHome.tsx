...
import {
  ...
  Tag, Clock, CreditCard, AlertTriangle, Check, ChevronRight, Truck, Users2, UserCheck, ClipboardList
} from 'lucide-react';
    ...
    apps: [
      {
        icon: Users2,
        label: 'Salesmen',
        description: 'Manage field sales team',
        path: '/salesmen',
      ...
      },
      {
        icon: UserCheck,
        label: 'Requests',
        description: 'Approve salesman access requests',
        path: '/salesmen/requests',
        gradient: 'from-cyan-500 to-blue-600',
        bg: 'bg-cyan-50',
        iconBg: 'bg-cyan-100',
        iconColor: 'text-cyan-600',
      ...
      },
      {
        icon: MapPin,
        label: 'Beat Routes',
        description: 'Plan and assign visit routes',
        path: '/beat-routes',
        gradient: 'from-emerald-500 to-teal-600',
        bg: 'bg-emerald-50',
        iconBg: 'bg-emerald-100',
      ...
      },
      {
        icon: TrendingUp,
        label: 'Performance',
        description: 'Monitor sales KPIs',
