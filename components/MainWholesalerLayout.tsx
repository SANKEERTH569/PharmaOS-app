    ...
    <>
      ...
      <div className="flex items-center justify-between px-5 h-[72px] border-b border-white/[0.06] shrink-0">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 to-purple-700 flex items-center justify-center shadow-lg shadow-violet-500/20 shrink-0">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500 font-semibold mt-0.5 tracking-wider uppercase">Wholesaler OS</p>
          </div>
        </div>
        <button
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={cn(
                        ...
                        active
                          ? 'bg-gradient-to-br from-violet-500 to-purple-700 shadow-md shadow-violet-500/20'
      ...
      <div className="mx-3 mb-3 rounded-xl bg-white/[0.04] border border-white/[0.06] p-4">
        <div className="flex items-center gap-2.5 mb-2">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-violet-500 to-purple-700 flex items-center justify-center shadow-sm shrink-0">
      ...
      <div className="p-3 border-t border-white/[0.06] shrink-0">
        <div className="flex items-center gap-2.5 px-2 py-2 mb-1">
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-violet-500 to-purple-700 flex items-center justify-center text-white font-bold text-sm shrink-0 shadow-sm">
            {mainWholesaler?.name?.charAt(0).toUpperCase() ?? 'W'}
          </div>
          <div className="min-w-0 flex-1">
            <p className="text-xs font-semibold text-white truncate leading-tight">{mainWholesaler?.name}</p>
            <p className="text-[10px] text-slate-500 truncate mt-0.5">@{mainWholesaler?.username}</p>
          </div>
        </div>
        <button
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-16 shrink-0 flex items-center justify-between px-5 lg:px-7 bg-white/80 backdrop-blur-xl border-b border-slate-200/60 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-2">
            <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 bg-violet-50 text-violet-700 rounded-full border border-violet-100">
              <span className="w-1.5 h-1.5 rounded-full bg-violet-500 animate-pulse" />
              <span className="text-[11px] font-semibold">Wholesaler</span>
            </div>
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-violet-500 to-purple-700 flex items-center justify-center text-white font-bold text-sm shadow-sm ml-1">
              {mainWholesaler?.name?.charAt(0).toUpperCase() ?? 'W'}
            </div>
          </div>
        </header>
